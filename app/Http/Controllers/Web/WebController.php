...
class WebController extends Controller
{
    ...
    // functions for static pages by prince
    public function p_shop(){
        return view('web-views2.p_shop');
    }
    public function ethical_standards(){
        return view('web-views2.ethical-standards');
    }
    public function learn_about_crystals(){
        return view('web-views2.learn-about-crystals');
    }
    ...
    public function complete_guide_to_crystals(){
        return view('web-views2.complete-guide-to-crystals');
    }
    public function crystal_energy_indexes(){
        return view('web-views2.crystal-energy-indexes');
    }
    public function crystal_articles(){
        return view('web-views2.crystal-articles');
    }
    public function feel_loved_crystal_stories(){
        return view('web-views2.feel-loved-crystal-stories');
    }
    public function login1(){
        return view('web-views2.login1');
    }
    public function choosing_crystals(){
        return view('web-views2.choosing-crystals');
    }
    public function carbon_footprint_sustainability(){
        return view('web-views2.carbon-footprint-sustainability');
    }
    public function my_journey(){
        return view('web-views2.my-journey');
    }
    public function p_cart(){
        return view('web-views2.p_cart');
    }
    public function p_checkout(){
        return view('web-views2.p_Checkout');
    }
    public function details(){
        return view('web-views2.details');
    }
    public function p_wishlist(){
        return view('web-views2.wishlist');
    }
}
