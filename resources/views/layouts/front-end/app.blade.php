...
<head>
    ...
    <!-- Apple Touch Icon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('public/assets/front-end/img/favicon.PNG')}}">

    <!-- Android Icon -->
    <link rel="icon" sizes="192x192" href="{{asset('public/assets/front-end/img/favicon.PNG')}}">

    <!-- MS Edge Icon -->
    <meta name="msapplication-TileImage" content="{{asset('public/assets/front-end/img/favicon.PNG')}}">
    ...
    <style type="text/css" id="nitro-critical-css">
        ...
        * {
        ...
        :root {
            ...
            --link_color-8a: hsla(var(--awb-custom_color_2-h),
            ...
            --fusion-woo-outofstock-badge-background-color: rgba(210,
                    0,
                    0,
                    0.9);
        ...
        @media only screen and (max-width: 1130px) {
            ...
            .fusion-flex-container {
                --awb-content-wrap: var(--awb-flex-wrap-medium,
                        var(--awb-flex-wrap));
            }
        ...
        @media only screen and (max-width: 640px) {
            ...
            .fusion-flex-container {
                --awb-content-wrap: var(--awb-flex-wrap-small,
                        var(--awb-flex-wrap));
            }
        ...
        @media only screen and (max-width: 640px) {
            .fusion-title {
                --awb-margin-top-small: var(--title_margin_mobile-top,
                        var(--awb-margin-top-medium));
                --awb-margin-right-small: var(--title_margin_mobile-right,
                        var(--awb-margin-right-medium));
                --awb-margin-bottom-small: var(--title_margin_mobile-bottom,
                        var(--awb-margin-bottom-medium));
                --awb-margin-left-small: var(--title_margin_mobile-left,
        ...
        @media only screen and (max-width: 1130px) {
            .fusion_builder_column {
                ...
                --awb-padding-bottom-medium: var(--awb-padding-bottom);
                --awb-padding-left-medium: var(--awb-padding-left);
                --awb-col-width: var(--awb-width-medium,
                        var(--medium-col-default));
                --awb-col-order: var(--awb-order-medium,
                        var(--awb-order-large));
                --awb-margin-top-medium: var(--awb-margin-top-large,
                        var(--col_margin-top, 0));
                --awb-margin-bottom-medium: var(--awb-margin-bottom-large,
                ...
                --awb-col-flex-grow: var(--awb-flex-grow-medium,
                        var(--awb-flex-grow, 0));
                --awb-col-flex-shrink: var(--awb-flex-shrink-medium,
        ...
        @media only screen and (max-width: 640px) {
            .fusion_builder_column {
                ...
                --awb-padding-bottom-small: var(--awb-padding-bottom-medium);
                --awb-padding-left-small: var(--awb-padding-left-medium);
                --awb-col-width: var(--awb-width-small,
                        var(--small-col-default));
                --awb-col-order: var(--awb-order-small,
                ...
                --awb-col-flex-grow: var(--awb-flex-grow-small,
                        var(--awb-flex-grow, 0));
                --awb-col-flex-shrink: var(--awb-flex-shrink-small,
                        var(--awb-flex-shrink, 0));
            }
    ...
    {{-- css changed by website --}}
    <link rel="stylesheet" onload="NPRL.onLoadStyle(this)" onerror="NPRL.onErrorStyle(this)"
        href="https://cdn-kepfd.nitrocdn.com/yhFRSzwhyHaKZOIOsRGVmHbaFTltymOf/assets/static/optimized/rev-4580688/moonrisecrystals.com/combinedCss/nitro-min-noimport-ac6fc2a97250fa39456e0bff54212d65-stylesheet.css" />
    <link rel="stylesheet" onload="NPRL.onLoadStyle(this)" onerror="NPRL.onErrorStyle(this)"
        href="https://cdn-kepfd.nitrocdn.com/yhFRSzwhyHaKZOIOsRGVmHbaFTltymOf/assets/static/optimized/rev-4580688/moonrisecrystals.com/externalFontFace/nitro-min-noimport-a751f119bb59108e690d237e2adf6caa-stylesheet.css" />
    <link rel="stylesheet" onload="NPRL.onLoadStyle(this)" onerror="NPRL.onErrorStyle(this)"
        href="https://cdn-kepfd.nitrocdn.com/yhFRSzwhyHaKZOIOsRGVmHbaFTltymOf/assets/static/optimized/rev-4580688/moonrisecrystals.com/combinedCss/nitro-min-noimport-32a3d7553982989f7b6cc757168d9364-stylesheet.css" />
    <link rel="stylesheet" href="https://moonrisecrystals.com/wp-content/uploads/fusion-styles/6a772e004b7ad041a9b784ddb3c6acb1.min.css">
