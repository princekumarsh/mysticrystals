...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    //routes by prince
    Route::get('/shop', 'WebController@p_shop')->name('p_shop');
    Route::get('/ethical-standards', 'WebController@ethical_standards')->name('ethical_standards');
    Route::get('/learn-about-crystals', 'WebController@learn_about_crystals')->name('learn_about_crystals');
    Route::get('/about', 'WebController@about')->name('about');
    Route::get('/contact', 'WebController@contact')->name('contact');
    Route::get('/complete-guide-to-crystals', 'WebController@complete_guide_to_crystals')->name('complete_guide_to_crystals');
    Route::get('/crystal-energy-indexes', 'WebController@crystal_energy_indexes')->name('crystal_energy_indexes');
    Route::get('/crystal-articles', 'WebController@crystal_articles')->name('crystal_articles');
    Route::get('/feel-loved-crystal-stories', 'WebController@feel_loved_crystal_stories')->name('feel_loved_crystal_stories');
    Route::get('/login', 'WebController@login1')->name('login1');
    Route::get('/choosing-crystals', 'WebController@choosing_crystals')->name('choosing_crystals');
    Route::get('/carbon-footprint-sustainability', 'WebController@carbon_footprint_sustainability')->name('carbon_footprint_sustainability');
    Route::get('/my-journey', 'WebController@my_journey')->name('my_journey');
    Route::get('/cart1', 'WebController@p_cart')->name('p_cart');
    Route::get('/checkout1', 'WebController@p_checkout')->name('p_checkout');
    Route::get('/details', 'WebController@details')->name('details');
    Route::get('/wishlist', 'WebController@p_wishlist')->name('p_wishlist');
});
